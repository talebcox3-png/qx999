(function () {
    ...
    settingsBox.innerHTML = `
        ...
        <input type="number" id="qx_delay" value="4" min="2" style="width:100%; padding:10px; background:#070d09; color:#fff; border:1px solid #1a3322; border-radius:8px; box-sizing:border-box; margin-bottom:15px; outline:none;">
    ...
    // হালকা কালো শ্যাডো এবং ৭৫% দৃশ্যমান রাখার জন্য অপাসিটি কমানো হলো
    function drawSkullShadow() {
        ...
        ctx.save();
        ctx.fillStyle = "rgba(0, 0, 0, 0.25)"; // অত্যন্ত হালকা কালো শ্যাডো, পেছনের সব স্পষ্টভাবে দেখা যাবে
    ...
    // স্ক্যান লাইনটি আরও স্মুথ ও স্লো করা হলো
    function drawSmokeScanLine() {
        ...
        grad.addColorStop(0.3, 'rgba(0, 255, 102, 0.06)');
        grad.addColorStop(0.7, 'rgba(0, 255, 102, 0.2)');
        ...
        scanY += 3.5; // স্পিড কমিয়ে অর্ধেক করা হলো যাতে অ্যানিমেশন স্লো হয়
    ...
    function executeTrade(direction) {
        ...
        if (direction === "UP") {
            targetBtn = allElements.find(el => {
                ...
                return text.includes("Up") || text.includes("Call") || text.includes("কল") || cls.includes("call") || cls.includes("green");
            });
        } else {
            targetBtn = allElements.find(el => {
                let text = (el.innerText || el.textContent || "").trim();
                let cls = (el.className || "").toString().toLowerCase();
                return text.includes("Down") || text.includes("Put") || text.includes("পুট") || cls.includes("put") || cls.includes("red");
            });
        }
